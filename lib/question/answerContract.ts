...
export function inferAnswerProfile(
  ...
  if (callType === "giving_interview") {
    return { mode: "technical", minWords: 80, maxWords: 140, maxOutputTokens: 380, requestProjectExample: hasRelevantProject, needsDiagnosis: false, needsSteps: false, needsValidation: false, needsTradeoff: false, responseSequence: ["direct answer", "reasoning or context", "concrete implication"], rationale: "interview default — elevated from brief" };
  }
